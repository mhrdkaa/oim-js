  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">Perbarui password akun Anda untuk keamanan</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-lg shadow-lg p-6">
          ...
          {success && (
            <div className="mb-4 p-3 bg-green-50 border border-green-200 text-green-700 rounded-lg animate-pulse">
              ...
              <p className="text-sm mt-1">Silahkan login ulang dengan password baru</p>
            </div>
          )}
            ...
            <div className="pt-4">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <button
                  type="submit"
                  disabled={loading}
                  className="bg-gradient-to-r from-purple-600 to-indigo-700 hover:opacity-90 text-white px-6 py-3 rounded-lg font-medium transition-all flex items-center justify-center space-x-2 disabled:opacity-50"
                >
                  <FaShieldAlt />
        ...
        <div className="bg-gradient-to-br from-purple-600 to-indigo-700 text-white rounded-lg shadow-lg p-6">
          <h3 className="text-lg font-semibold mb-4">Pedoman Password Aman</h3>
          <ul className="space-y-3">
            <li className="flex items-start">
              <span className="mr-2">•</span>
              <p className="text-sm text-purple-100">Gunakan kombinasi huruf besar, kecil, angka, dan simbol</p>
            </li>
            <li className="flex items-start">
              <span className="mr-2">•</span>
              <p className="text-sm text-purple-100">Minimal 6 karakter, lebih panjang lebih aman</p>
            </li>
            <li className="flex items-start">
              <span className="mr-2">•</span>
              <p className="text-sm text-purple-100">Jangan gunakan informasi pribadi seperti tanggal lahir</p>
            </li>
            <li className="flex items-start">
              <span className="mr-2">•</span>
              <p className="text-sm text-purple-100">Ganti password secara berkala (setiap 3 bulan)</p>
            </li>
            <li className="flex items-start">
              <span className="mr-2">•</span>
              <p className="text-sm text-purple-100">Jangan gunakan password yang sama untuk multiple akun</p>
            </li>
          </ul>
        </div>
      </div>
